...
/*
 * This interface BookingRepo is used to interact with the database and perform CRUD 
 * operations on the BookingDomain entities. The interface is annotated with @Repository 
 * which is a Spring Data annotation and indicate that this is a Spring Data repository. 
 * The interface extends JpaRepository<BookingDomain, Long> which is a Spring Data 
 * interface that provides several methods for interacting with a JPA-based data 
 * repository. By extending this interface, BookingRepo inherits all of the basic CRUD 
 ...
 * operations on the database table representing the Booking.
 */
